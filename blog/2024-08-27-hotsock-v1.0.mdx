...
authors: [james]
tags: [releases, websockets, real-time]
description: Hotsock v1.0 is here! Deploy a full-featured, self-hosted WebSocket service in your AWS account. Get private channels, presence tracking, custom domains, and more with complete data privacy.
---
...
### Publish real-time messages {/* #publish-real-time-messages */}
...
### Subscribe your clients {/* #subscribe-your-clients */}
...
### Combining the best of fully-managed with self-hosted {/* #combining-the-best-of-fully-managed-with-self-hosted */}
...
### Helper tools and libraries {/* #helper-tools-and-libraries */}
