...
### Automatic fan-out for large channels {/* #automatic-fan-out-for-large-channels */}
...
### Catching up: v1.8 and v1.9 {/* #catching-up-v18-and-v19 */}

Since the last feature post covered v1.7, here's a quick recap of what's shipped since then.

#### Stored message querying (v1.8) {/* #stored-message-querying-v18 */}
...
#### Revamped Web Console (v1.9) {/* #revamped-web-console-v19 */}
...
#### Overhauled CloudWatch Dashboard (v1.8) {/* #overhauled-cloudwatch-dashboard-v18 */}
