...
description: Hotsock v1.7 adds automatic channel subscription on connect and broadcast messaging to unsubscribed channels. Simplify real-time apps with reduced client-side complexity.
---
...
### Automatic channel subscriptions {/* #automatic-channel-subscriptions */}
...
### Broadcasting to unsubscribed channels {/* #broadcasting-to-unsubscribed-channels */}
