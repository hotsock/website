...
authors: [james]
tags: [releases, features, scheduler]
description: Hotsock v1.5 introduces scheduled message delivery using Amazon EventBridge Scheduler. Schedule messages for future delivery and debug with improved web console and error messages.
---
...
#### Send messages via HTTP API {/* #send-messages-via-http-api */}
