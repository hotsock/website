...
authors: [james]
tags: [releases, features, message-storage]
description: Hotsock v1.3 adds message storage and HTTP API for retrieving message history. Store messages for any duration and query historical data through a simple client API.
---
...
### Query channel message history {/* #query-channel-message-history */}
...
### Expand visibility with the `historyStart` claim {/* #expand-visibility-with-the-historystart-claim */}
...
### Publish client messages with HTTP {/* #publish-client-messages-with-http */}
