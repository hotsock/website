...
## Manually update installation {/* #manually-update-installation */}
...
Select the "Test" tab then click the "Test" button to trigger a manual stack update. If the test is successful, the update was initiated and will complete within 2-3 minutes. You can follow the stack update in the CloudFormation console.
