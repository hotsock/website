...
## Request and verify a certificate {/* #request-and-verify-a-certificate */}
...
## Update your Hotsock installation {/* #update-your-hotsock-installation */}
...
### Using Route 53 (ALIAS Record) {/* #using-route-53-alias-record */}
...
### Using Other DNS Providers (CNAME Record) {/* #using-other-dns-providers-cname-record */}
