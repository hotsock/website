...
- ~Middle East (Bahrain) - me-south-1~ Temporarily unavailable [Learn More](https://health.aws.amazon.com/health/status?region=me-south-1)
...
- Asia Pacific (New Zealand) - ap-southeast-6: Missing API Gateway WebSockets, Missing Lambda function URLs
- Asia Pacific (Taipei) - ap-east-2: Missing API Gateway WebSockets, Missing Lambda function URLs
