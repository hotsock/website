...
description: Install Hotsock in your AWS account a few minutes using CloudFormation. Step-by-step guide with AWS CLI and Console options for deploying production-ready infrastructure.
---
...
## Stack outputs and endpoints {/* #stack-outputs-and-endpoints */}
...
### DynamoDB & DynamoDB Streams {/* #dynamodb--dynamodb-streams */}
