...
## v1.4.0 - July 13, 2025 {#v1.4.0}

- Add the ability to disable connection count tracking for channel subscriptions with [`omitFromSubCount`](../connections/claims.mdx#channels.omitFromSubCount). This is an optional cost reduction measure for cases where knowing the count.
...
- Update all aws-sdk-go-v2 SDK modules to their latest versions (as of [2025-05-09](https://github.com/aws/aws-sdk-go-v2/releases/tag/release-2025-05-09)).
