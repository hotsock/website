...
You can also use the web console to unsubscribe from channels, send pings and heartbeats, test disconnect/reconnect, get/set channel storage, and test sending your own raw messages on the WebSocket. Use the dropdown menu at the bottom to select the action you need.
