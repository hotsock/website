...
description: Secure WebSocket authentication with JWT tokens. Learn how Hotsock uses HMAC, RSA, ECDSA, and EdDSA signing methods to authenticate connections and authorize channel access.
---
...
## Set signing method in Hotsock {/* #set-signing-method-in-hotsock */}
...
### RSA / ECDSA / EdDSA {/* #rsa--ecdsa--eddsa */}
...
#### Generate a secure signing key {/* #generate-a-secure-signing-key */}
