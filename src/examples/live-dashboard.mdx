...
### Server-published messages {/* #server-published-messages */}
...
### Subscribing and binding multiple events {/* #subscribing-and-binding-multiple-events */}
...
### Rendering real-time data {/* #rendering-real-time-data */}
